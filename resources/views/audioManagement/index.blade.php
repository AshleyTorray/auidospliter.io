                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <table class="border-collapse border border-slate-400 w-full">
                        ...
                        <tbody>
                            ...
                            <tr class = "h-12">
                                <td class="border border-slate-300 "><p class = "text-center">{{$file->file_name}}</p></td>
                                ...
                                <td class="border border-slate-300 w-44">
                                    <button class = "font-semibold float-left text-sm rounded-md border-solid border-2 border-indigo-600 h-8 w-14 mx-4" type = "button" value = "split">Play</button>
